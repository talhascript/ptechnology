        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{data.section1.title}</h1>
              <p className="mt-6 text-xl leading-8 text-gray-700">{data.section1.subtitle}</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                {data.section2.features.map((feature, index) => (
                  <li key={index} className="flex gap-x-3">
                    ...
                    <span>
                      <strong className="font-semibold text-gray-900">Feature {index + 1}</strong> {feature.text}
                    </span>
                  </li>
                ))}
              </ul>
              ...
              <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">{data.section3.title}</h2>
